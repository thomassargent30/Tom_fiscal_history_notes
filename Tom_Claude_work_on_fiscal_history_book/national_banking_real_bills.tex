...
State bank notes were attacked from two directions.  A 10~percent federal tax
...
absence of a lender of last resort, private co-ordination by a single wealthy
...
(Republican, New York) and championed in the Senate by Nelson W.\ Aldrich
...
stock-market speculators.  Wilson clinched the passage of the bill in the Senate by
...
The most consequential application of the real bills doctrine came in late 1929.
...
initiative: a letter to all member banks requiring any bank that sought discount
...
partnership, or corporation'' in ``unusual and exigent circumstances''---a
provision that traces its legislative DNA to the Aldrich--Vreeland emergency
