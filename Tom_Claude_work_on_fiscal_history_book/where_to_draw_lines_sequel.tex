...
executive-branch defender.  Most
...
reversals---Friedman, Clay, Webster, Gallatin, Madison, Chase---and
then turns to a further reversal that unfolded at the institutional level
over half a century:
...
throughout American economic history.  The six individual cases examined
here---Friedman's shift from fiscal coordination to monetary rules;
...
charter to serving as its legal champion and political defender;
Gallatin's transformation from Jeffersonian critic of Hamilton's Bank to
its strongest executive-branch advocate; Madison's move from
strict-constructionist critic to pragmatic signer of the Second Bank
bill; and Chase's extraordinary journey from hard-money Democrat to
greenback architect to constitutional counter-revolutionist---all
illustrate the same underlying truth: the optimal institutional line
responds to circumstances, and circumstances change.
