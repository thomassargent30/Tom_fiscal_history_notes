...
rule---and Paul Volcker's short-lived operationalization of that rule in
1979--82 demonstrated that sustaining it requires an institutional
environment that the American financial system could not maintain.
Henry Clay and James Madison each opposed the First Bank of the
...
fiscal cost of having no national monetary institution.
Daniel Webster voted against the charter of the Second Bank in 1816 but
within three years had become its foremost legal champion.  Albert
Gallatin entered Congress as a Jeffersonian critic of Hamilton's financial
system and became, as Secretary of the Treasury, the Bank's strongest
executive-branch defender.  Most dramatically, Salmon P.\ Chase spent a
career as a hard-money Jacksonian Democrat, engineered the Legal Tender
Acts as Secretary of the Treasury in the Civil War, and then, as Chief
Justice, wrote the opinion in \textit{Hepburn v.\ Griswold} (1870)
declaring his own Acts unconstitutional.  The essay then extends the
American nineteenth-century record with three twentieth-century
parallels.  John Maynard Keynes traveled the opposite path from
Friedman: from sophisticated defender of the gold exchange standard in
1913 to author of the most celebrated indictment of gold discipline in
the English language, driven by his reading of the deflationary costs
that the restored gold parity imposed on post-war Britain.  Marriner
Eccles championed the Federal Reserve's wartime bond-price peg---making
the Fed a fiscal instrument of the Treasury---and then, demoted by
Truman for his efforts, became the leading institutional advocate of the
Treasury-Fed Accord that restored monetary independence in 1951.  Richard
Nixon campaigned against Keynesian fiscal expansion and then, on a single
Sunday evening in August 1971, closed the gold window, imposed
wage-price controls, and declared himself ``a Keynesian in economics.''
The essay also turns from individual reversals to institutional ones:
the half-century redrawing of the line between \emph{money} and
\emph{credit}, from the bond-backed currency of the National Banking
Acts that Chase championed to the real-bills provisions of the Federal
Reserve Act of 1913; and, as a British parallel, the story of Robert
Peel's Bank Charter Act of 1844 and its three suspensions---a statutory
line bent, not repealed, by the logic of acute financial crisis, and the
occasion for Bagehot's inversion of Currency School orthodoxy.  These
reversals are not signs of weakness or inconsistency; they are evidence
of how contextually sensitive, and how consequential, the institutional
lines really are.  They also reveal a structural pattern: reversals
cluster at moments of systemic stress---wars, panics, and
depressions---when the costs of the existing institutional arrangement
suddenly become undeniable to multiple actors at once.
\end{abstract}
%
%\tableofcontents
%\bigskip
...
authorities  is an unsettling and consequently unsettled issue.
...
%historical record suggests otherwise. 
 Some of the most able statesmen
and economists in American and British history changed their minds,
sometimes more than once, and sometimes in ways that placed them in
direct tension with their earlier selves.  This essay examines six
individual reversals in American history---Friedman, Clay, Webster,
Gallatin, Madison, Chase---and three in the twentieth century that
exhibit a similar same pattern---Keynes, Eccles, Nixon---and then turns to two
institutional reversals that unfolded over decades: Congress's stepwise
...
crises and bent without ever being formally repealed.
...
theorist of the founding generation.  Financial challenges brought with the
War of 1812, fought without a national bank capable of mobilizing
government credit, influenced both of them.  Two other  conversions
...
Perhaps the  most dramatic individual reversal belongs to Salmon P.\ Chase.  A
...
The twentieth-century parallels extend the pattern in instructive
directions.  John Maynard Keynes moved from sophisticated defender of
the gold exchange standard to its most celebrated opponent, driven by
his reading of the deflationary costs that gold imposed on post-war
Britain.  His trajectory is the mirror image of Friedman's: both men
...
My theme is not that these figures were confused or hypocritical.
...
in \citet{Sargent2011} is not merely a theoretical curiosity; it involves a real  live political and constitutional choices that intelligent people
answer differently in different contexts, and sometimes answer differently
over the course of a single lifetime.

One further structural pattern deserves notice from the outset.  The
reversals documented here cluster at moments of systemic stress.  The
...
suggests that the decisive  ``forcing function'' is not gradual evidence-accumulation
alone, but crisis-induced surprises or revelations:  costs of existing
institutional arrangement that were tolerable in a steady fiscal
environment suddenly become undeniable to multiple actors.
...
depends on parameterization and context.  This is the sense in which a
...
\subsection{Paul Volcker and the Test of Friedman's Rule}

Friedman's $k$-percent rule was not merely an academic proposal; it was
operationalized---once---at the Federal Reserve.  On October 6, 1979,
...
Daniel Webster's trajectory offers a complementary reversal from the
opposite end of the partisan spectrum.  Webster entered the House of
...
stood beside Clay as one of the two most formidable Senate opponents of
Jackson's campaign to destroy the institution.

Webster's reversal is less ideological than Clay's---he moved from
objecting to a specific legislative design to championing the
institution as a legal and political cause, rather than crossing a deep
philosophical divide---but it illustrates an additional mechanism of
...
the Bank---to relentless scrutiny, viewing them as instruments of
...
Gallatin's conversion is significant for the argument of this essay
because it was driven not by the shock of wartime emergency---which came
later---but by the quieter accumulation of administrative evidence.
...
their foremost theorist---intended it as the hardest possible statutory
...
indemnity.  In~1866, after the spectacular collapse of Overend, Gurney
...
constitutes the most intellectually consequential commentary on this
...
And in both cases the most penetrating analytical response was not a
...
The individual and institutional reversals catalogued above all belong,
in the main, to the nineteenth century and the first years of the
twentieth.  Three twentieth-century episodes extend the same pattern
with additional precision, and together they illuminate dimensions of
the stability--efficiency trade-off that the earlier record leaves
implicit.

\subsection{John Maynard Keynes: From Gold Standard Defender to
             Its Foremost Critic}

Among economists, the most consequential reversal of the twentieth
century belongs to John Maynard Keynes.  Its direction is the mirror
image of Friedman's: where Friedman moved from a design coupling
monetary policy to fiscal outcomes toward a strict monetary rule
independent of the budget, Keynes moved from sophisticated defense of a
specie-based monetary constraint toward the most influential advocacy
of managed money and fiscal flexibility in the English language.

Keynes's starting point was \textit{Indian Currency and Finance}
\citep{Keynes1913}, published in the same year as the Federal Reserve
Act.  The book analyzed India's gold exchange standard with broadly
affirmative conclusions: the system was, Keynes argued, a rational
institutional evolution that captured the price-stability benefits of
gold convertibility without requiring the costly maintenance of a full
gold circulation.  He commended the system's efficiency and stability.
The book was received---and later remembered, not entirely fairly---as
evidence of a youthful attachment to specie discipline \citep{Moggridge1992}.
...
restoration of pre-war parities a program of systematic deflation rather
than of genuine price stability.  By 1923, when Keynes published
\textit{A Tract on Monetary Reform} \citep{Keynes1923}, his position
had inverted.  The gold standard, he wrote, was ``already a barbarous
relic''; the sensible objective was to manage the price level directly
through central bank discretion rather than to subordinate domestic
economic conditions to the requirements of an external specie constraint.
The book proposed a ``managed currency'' in which the central bank would
target some combination of price-level and output stability, using its
instruments actively rather than following a specie rule.  This is, in
the taxonomy of \citet{Sargent2011}, a shift from monetary dominance
(the gold standard binds the monetary authority, forcing fiscal and wage
adjustment) toward managed discretion---not quite fiscal dominance, but
a regime in which the monetary authority responds to economic conditions
rather than to a fixed specie constraint.

The intellectual break became concrete in ``The Economic Consequences of
Mr.~Churchill'' \citep{Keynes1931}, originally published in 1925.
Keynes attacked Winston Churchill's decision to return Britain to the
gold standard at the pre-war parity of \$4.86.  The pre-war rate
overvalued sterling by approximately 10 percent relative to the dollar,
requiring British wages and prices to fall by that margin to restore
international competitiveness.  Keynes predicted with precision the
consequences that followed: industrial contraction, the coal dispute that
became the General Strike of 1926, prolonged unemployment in the export
industries, and a deflationary drag that persisted until Britain finally
abandoned gold in 1931.  The episode confirmed for Keynes---and for many
who watched---that the price of monetary discipline under gold could be
measured not in abstract stabilization calculus but in unemployment
rates and broken industries.

Keynes's reversal illuminates the logic of \citet{Sargent2011} precisely
because it mirrors Friedman's in structure while inverting its conclusion.
Both were updating the same trade-off in response to the same cluster of
historical events---the collapse of the pre-war monetary order, the Great
War, the interwar deflation---but each concluded that the other's
preferred failure mode was the more serious danger.  Keynes, observing the
interwar years from the vantage of deflationary Britain, concluded that
the cost of adjustment under specie discipline was the dominant risk:
the monetary authority must retain discretion to prevent deflation, even
at the cost of a weaker price-level anchor.  Friedman, composing the
\textit{Monetary History} with Schwartz \citep{FriedmanSchwartz1963},
concluded that the failure of the monetary authority to maintain a stable
money supply under discretionary management was the dominant risk: the
central bank must be bound by a rule, even at the cost of fiscal
inflexibility.  Each was correct about the failure mode he emphasized, and
each was less attentive to the failure mode emphasized by the other.
\citet{Eichengreen1992} shows at length how the gold standard constrained
monetary responses to the Depression; \citet{FriedmanSchwartz1963}
demonstrates how the Federal Reserve's discretionary failures deepened it.
Both accounts are accurate.  The divergent conclusions that Keynes and
Friedman drew from the same evidence are not a sign that one was wrong;
they are the analytical content of the no-dominant-option result of
\citet{Sargent2011}.

\subsection{Marriner Eccles and the Treasury--Fed Accord of 1951}

The twentieth century's most structurally precise parallel to Chase's arc
belongs to Marriner Eccles.  As Chairman of the Federal Reserve from 1934
to 1948, Eccles championed the wartime arrangement under which the Fed
pegged Treasury bond prices---holding 90-day bill yields at
$\tfrac{3}{8}$~percent and long bond yields at $2\tfrac{1}{2}$~percent
regardless of monetary conditions.  Like Chase's endorsement of the Legal
Tender Acts, this was a deliberate crossing to fiscal dominance under
wartime pressure: the monetary authority became an unlimited buyer of
government securities at whatever volume was needed to keep the
government's borrowing costs low.  Seigniorage was whatever the wartime
fiscal program required; the price level was the fiscal residual.  Eccles
understood the inflationary risk and accepted it as the price of war
finance.  He said so explicitly in congressional testimony and in his
memoir \citep{Eccles1951}.

The parallel to Chase deepens in the postwar period.  As wartime controls
were lifted and inflation accelerated, the bond-price peg required the
Fed actively to expand its balance sheet to prevent bond yields from
rising.  This meant accommodating inflationary pressure rather than
resisting it---a role that Eccles, who had championed the peg for wartime
reasons, now found untenable.  By 1948, his public and internal arguments
for restoring Federal Reserve independence had become a political
liability.  President Truman demoted Eccles from the chairmanship to an
ordinary Board seat, replacing him first with Thomas McCabe.  Like Chase,
who used his Chief Justiceship to attack the Acts he had himself designed,
Eccles used his reduced institutional position to keep pressing for
monetary independence---and, like Chase, he was penalized for the attempt.
The man who had designed and championed the fiscal-dominance arrangement
was removed from its administration precisely because he had concluded it
needed to end.
...
The Fed regained the authority to set interest rates to serve monetary
objectives without regard to Treasury borrowing costs; monetary dominance
was restored.  The Accord became, in subsequent decades, the founding
charter of American central bank independence---the institutional line
whose integrity each successive episode of fiscal pressure would test
\citep{Meltzer2003}.

What explains the different outcome compared to Chase's trajectory?  Where
Chase's \textit{Hepburn} decision was reversed by \textit{Knox} and
extinguished by \textit{Juilliard}, the Accord held.  Several features of
the postwar environment appear decisive.  First, the inflationary
consequences of the peg were visible and politically salient in a way
that the deflationary consequences of Civil War-era monetary contraction
were not.  The peg was producing inflation that hurt middle-class savers;
the political coalition for monetary independence could therefore extend
beyond financial elites.  Second, the Korean War, while generating some
pressure for continued Treasury accommodation, did not produce the
existential fiscal emergency of 1861--65; borrowing requirements were
manageable without monetization.  Third---and perhaps most
importantly---the Fed had a credible and immediately exercisable
alternative: raise interest rates today, without any legislative action.
Chase, by contrast, needed the Court to strike down a statute; the
institutional inertia ran in the opposite direction.  Soft constraints
succeed when the political environment can sustain them; the Accord held
because the inflation tax imposed by the peg had created a constituency
for its removal that the Civil War greenbacks had not.

\subsection{Richard Nixon and the End of Bretton Woods}

If Chase's career is the most internally dramatic of the nineteenth-century
reversals, Richard Nixon's New Economic Policy of August~1971 is its
twentieth-century counterpart in terms of surface paradox.  Nixon had
built his political identity as the anti-Keynesian: his 1968 campaign
attacked Lyndon Johnson's ``guns and butter'' policy, the inflationary
combination of Vietnam War spending and Great Society expansion without
compensating tax increases.  He opposed discretionary deficit spending
and price controls, the signature instruments of Keynesian demand
management.  His initial Council of Economic Advisers chairman, Paul
McCracken, was a monetarist-inflected fiscal conservative.

The Bretton Woods system---linking the dollar to gold at \$35 per ounce
and other currencies to the dollar---was the twentieth century's
international analog of the gold standard: a form of monetary dominance
at the systemic level, in which the dollar's gold peg constrained American
fiscal and monetary policy in precisely the way the domestic gold
standard had constrained individual economies in Keynes's time.  By~1971,
years of persistent balance-of-payments deficits, generated by the fiscal
costs of Vietnam and the Great Society, had depleted the American gold
stock and filled foreign central banks with dollars they were
increasingly inclined to convert.  The fiscal dominance latent in
Johnson's spending decisions had gradually undermined the monetary
constraint, just as Sargent--Wallace ``unpleasant arithmetic'' would
predict.

On the evening of Sunday, August~15, 1971, Nixon announced the New
Economic Policy.  In a single televised address he simultaneously
suspended dollar--gold convertibility (ending Bretton Woods), imposed a
ninety-day freeze on wages and prices (the instrument he had specifically
opposed), and announced a Keynesian stimulus package designed to ensure
re-election in 1972 \citep{Matusow1998}.  He told his economic advisers,
in the phrase that became the shorthand for the entire episode, ``I am
now a Keynesian in economics.''

Nixon's reversal differs from the wartime reversals in one important
respect.  It was not compelled by active military emergency in any
proximate sense.  Vietnam was ongoing, but the balance-of-payments
pressure that broke Bretton Woods was fundamentally fiscal: the
accumulated legacy of years of ``guns and butter'' spending, which had
inflated the dollar monetary supply relative to gold reserves.  The
connection to war was mediated through fiscal consequences rather than
through the direct demands of military finance.  This is the peacetime
version of the mechanism \citet{Sargent2011} identifies: when fiscal
dominance is the revealed preference of the political system, no external
monetary anchor can hold indefinitely against the accumulated pressure,
even in the absence of immediate armed conflict.

The temporary also became permanent, as it had after the Civil War.
Nixon announced the gold window closure as provisional, pending
international monetary reform.  Reform came, in qualified fashion, at
the Smithsonian Agreement in December~1971 and at Kingston in~1976; but
the dollar's gold link was never restored.  \citet{Gowa1983} documents
the political economy of this irreversibility in detail, showing that
the domestic fiscal commitments which had caused the balance-of-payments
crisis were not retracted, and without their retraction the gold price
could not have been defended.  The emergency of August~1971, like Chase's
wartime greenbacks, became the permanent monetary constitution of the
world it had transformed.
...
the costs of the existing institutional arrangement---however
imperfect---are broadly distributed across time and may be tolerable.
Under the concentrated demands of war or systemic panic, they become
immediate and undeniable.  The fiscal-dominance arrangement---using
monetary instruments to finance emergency expenditures---becomes
irresistible precisely because the alternative is defeat or systemic
collapse.  This is not an argument against institutional constraints on
fiscal-monetary coordination; it is a reminder that any such constraints
must be evaluated in part by their behavior under the extreme stress
cases that history periodically and unpredictably generates.
...
adds a dynamic dimension: the transitions between regimes---forced by
crisis---may matter as much as the steady states themselves.  A well-
designed monetary-dominant regime that collapses under wartime pressure
may leave the fiscal authority worse off than a more flexible
fiscal-dominant regime that never pretended to prohibit seigniorage.
The value of an institutional commitment depends not only on its
steady-state properties but on its resilience when tested.
...
systematic bias toward fiscal expansion.  Keynes could not have known
in 1913 what the Great War's fiscal demands would do to the monetary
system whose workings he had so carefully described.  Experience updated
...
political economy would not sustain that absolutism.  Peel's Bank
Charter Act illustrates the same tension in statutory form: a rule rigid
enough to command credibility was not flexible enough to survive a
genuine crisis, and Bagehot's response---accept the constraint on paper
while institutionalizing its suspension as lender-of-last-resort
doctrine---was the most intellectually honest resolution available.
...
and eventually the Legal Tender Acts.  Nixon announced the gold window
...
discovered---fragile in the face of sustained fiscal pressure.
...
and fiscal pressures.  Chase's personal monetary principles were genuine
and deeply held; he had stated them publicly for decades.  Under
...
that had driven the abandonment had not themselves changed.  Eccles
faced the same discovery: he could advocate for monetary independence
from a demoted Board seat, but he could not restore it unilaterally.
...
\textit{The asymmetry of conclusions from the same evidence.}  The most
intellectually arresting observation to emerge from placing the reversals
side by side is that the same historical events can drive different
analysts to opposite conclusions.  The interwar monetary disorder drove
Keynes toward managed money and fiscal flexibility and drove Friedman
toward a binding monetary rule.  The Great Depression confirmed for
Keynes that deflation under gold discipline was unsustainable; for
Friedman, it confirmed that monetary contraction under discretionary
management was the primary danger.  Both conclusions were correct about
the failure mode each emphasized; each was less attentive to the failure
mode emphasized by the other.  This is not relativism: it is the
analytical content of the no-dominant-option result of \citet{Sargent2011}.
The correct institutional conclusion from the same historical experience
depends on a judgment about which of two genuine risks is the greater
one---and that judgment, as the cases show, can differ between equally
...
throughout American and British economic history.  The nine individual
cases examined here---Friedman's shift from fiscal coordination to
monetary rules; Volcker's adoption and abandonment of Friedman's rule;
Clay's conversion from Republican opponent to Whig champion of the
national bank; Webster's progression from opposing the Second Bank's
charter to serving as its legal champion; Gallatin's transformation from
Jeffersonian critic of Hamilton's Bank to its strongest executive-branch
advocate; Madison's move from strict-constructionist critic to pragmatic
signer of the Second Bank bill; Chase's extraordinary journey from
hard-money Democrat to greenback architect to constitutional counter-
revolutionist; Keynes's passage from gold-exchange defender to the
author of ``barbarous relic''; and Eccles's arc from wartime
fiscal-dominance architect to champion of the Accord that restored
monetary independence---all illustrate the same underlying truth:
the optimal institutional line responds to circumstances, and
circumstances change.  Nixon's New Economic Policy adds a further
illustration: when fiscal dominance is the revealed preference of the
political system, no external monetary anchor can hold indefinitely, even
in peacetime.

That truth is confirmed, at the legislative level, by the half-century
redrawing of the money--credit line examined above.  The bond-backed
currency of the National Banking System was a stable but inflexible
answer to the question ``what should money be backed by?''  The real
bills doctrine of the Federal Reserve Act offered a more elastic answer
that solved the inelasticity problem while importing the procyclical
instability that Thornton had identified in 1802 and that Friedman and
Schwartz held responsible for the catastrophe of 1929--33.  Peel's Bank
Charter Act across the Atlantic tells a parallel story: a monetary rule
inscribed in statute proved unable to survive three successive crises
without executive suspension, and the most penetrating response was not
a repeal of the rule but Bagehot's reformulation---transforming the
exception into a doctrine of active crisis lending.  The theoretical
reconsideration by \citet{SargentWallace1982}, showing that a real-bills
regime can be Pareto superior to a quantity-theory alternative,
demonstrates that the congressional reversal from bond-backing to real
bills, like the individual reversals, reflects a genuine analytical
trade-off rather than mere confusion.

This is not an argument for institutional nihilism.  The historical
record also supports Friedman's conviction that price-level stability
requires commitments that are robust to fiscal pressure, and that such
robustness is hard to achieve and easy to destroy.  The Second Bank was
chartered in 1816 in response to the fiscal lessons of 1812 and
destroyed by 1836 in response to political pressures that its designers
had not foreseen.  The Legal Tender Acts were upheld by a reconstituted
Court and confirmed as permanent sovereignty in \textit{Juilliard}.  The
Bretton Woods gold link, announced as temporary in August~1971, was never
restored.  The trajectory is one of progressive erosion of monetary
constraints under fiscal pressure---what the paper has called the ratchet.

The cases do counsel, however, for humility about institutional design.
Principled people who have thought carefully about where to draw the
lines have repeatedly found themselves unable to maintain those lines in
the face of changed circumstances, new evidence, and the coercive logic
of fiscal emergency.  That reversals cluster at historical stress
points---wars, panics, depressions---is not surprising; it is the
analytical content of \citet{SargentWallace1981}.  What is surprising,
and sobering, is that the reversals are so rarely provisional: the
emergency measure typically becomes the permanent settlement.  Designing
institutions that are both responsive enough to survive systemic stress
and durable enough to provide the stability that is their purpose is the
enduring challenge.  The reversals documented here are a measure both of
how difficult that challenge is, and of how much depends on getting the
answer right.
