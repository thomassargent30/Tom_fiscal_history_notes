...
\begin{abstract}
This sequel to \citet{Sargent2011} documents a catalogue of consequential
reversals that illustrate the stability-versus-efficiency trade-off
at the heart of that essay.  That paper asked where to draw
lines between (1)~markets for money and credit, and (2)~monetary and
fiscal policies, showing that in both domains drawing sharp lines
purchases price-level stability at a cost in economic efficiency, while
erasing them promotes efficiency at the risk of instability.  Milton
Friedman moved from a 1948 proposal that implemented fiscal dominance over monetary policy to a 1960 proposal that implemented monetary policy dominance over fiscal policy; Volcker's 1979--82 attempt
to implement a version of Friedman's 1960 policy lasted only a few quarters.  Clay and
...
declaring his own Acts unconstitutional.  Keynes moved from defender of the gold
...
\citet{Sargent2011} asked where to draw institutional lines between
(1)~markets for money and credit, and (2)~monetary and fiscal policies.
The essay argued that in both domains a genuine stability-versus-efficiency
trade-off makes the choice difficult.  Drawing a sharp line between money
...
and invite regulatory evasion.  The real bills doctrine, associated with
Adam Smith, prescribes erasing that line by permitting banks to issue notes
...
superior to quantity-theory legal restrictions, while the same framework
also reveals that the real bills criterion can be procyclical and
destabilizing.  On the monetary--fiscal side, the ``unpleasant arithmetic''
...
and economists i changed their minds,
sometimes more than once.  This essay examines five
iAmericans'  reversals in during the nineteenth century --- Clay, Webster,
