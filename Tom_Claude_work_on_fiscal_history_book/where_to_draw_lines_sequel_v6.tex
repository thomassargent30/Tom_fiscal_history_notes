...
\begin{abstract}
 \citet{Sargent2011}
% documents a catalogue of consequential
%reversals that illustrate the stability-versus-efficiency trade-off
%at the heart of that essay.  That paper
described  how  drawing sharp
lines between (1)~markets for money and credit, and (2)~monetary and
fiscal policies purchases price-level stability at a cost in economic efficiency, while
erasing them promotes efficiency at the risk of instability.  This sequel tells how distinguished public intellectuals and statesmen were open to changing their minds about these arrangements.  Milton
Friedman moved from a 1948 proposal that implemented fiscal dominance over monetary policy to a 1960 proposal that implemented monetary policy dominance over fiscal policy;   Paul Volcker's 1979--82 attempt
to implement a version of Friedman's 1960 policy lasted only a few quarters.    James 
Madison and Henry Clay each opposed the First Bank of the United States  on constitutional grounds, then
became architects of the Second Bank after the War of 1812.  Salmon P.\ Chase
...
declaring those  Acts unconstitutional. John Maynard  Keynes moved from defending the gold
exchange standard to recommending that it be abandoned; Mariner  Eccles
...
%Congress's half-century
%redrawing of the money--credit line from US Treasury bond backed National Bank Notes
%to the real-bills Federal Reserve Act; Peel's Bank Charter Act of
%1844 was suspended in every major crisis within a generation of its
%passage.  
%These reversals are evidence of how contextually sensitive,
%and how consequential, drawing and sustaining those lines can be.
\end{abstract}
%
%\tableofcontents
%\bigskip
...
\citet{Sargent2011} described stability-versus-efficiency tradeoffs associated with alternative 
ways  to draw institutional lines between
(1)~markets for money and credit, and (2)~monetary and fiscal policies.
 Drawing a sharp line between money
and credit---for example, requiring banks to hold 100-percent reserves or
confining note issuance to government bonds only---can stabilize the price
level, but creates rate-of-return wedges that are economically inefficient
and invite regulatory evasion.  Adam Smith's real bills doctrine
prescribes erasing that line by permitting banks to issue notes
against sound short-term private claims; \citet{SargentWallace1982} showed
in a general-equilibrium setting that such free intermediation can be Pareto
superior to quantity-theory legal restrictions while simultaneously promoting price level instability.
  On the monetary--fiscal side, the ``unpleasant arithmetic''
of \citet{SargentWallace1981} identifies an analogous tension: a monetary
authority that commits credibly to a price-level path forecloses money
creation as a fiscal instrument, purchasing stability at the cost of a
constrained fiscal toolkit; a passive monetary authority accommodates
fiscal needs but exposes the price level to fiscal pressures.  In neither
domain does has one of the polar arrangements been permanently sustained.  Able American and British  statesmen
and economists  changed their minds about where to draw lines,
sometimes more than once.  This essay examines five
Americans'  reversals in during the nineteenth century --- Henry Clay, Daniel Webster,
Albert Gallatin, James Madison, Salmon P. Chase---and three in the twentieth century---John Maynard Keynes, Mariner Eccles, Richard Nixon---and then turns to two
...
entirely from the budget, trading seigniorage flexibility for price-level
stability.  The subsequent history of Friedman's
...
Each reversal came with justifications pointing to how changed circumstances
...
Gallatin's earlier administrative conclusions.  The Civil War  led  Chase to support the bond-backed currency system.  The Great War and its
deflationary aftermath drove Keynes's thinking..  World War~II created
...
suggests that the ``forcing function'' is not only  gradual evidence-accumulation
alone, but crisis-induced opportunism: costs of the existing
...
The stability-versus-efficiency trade-off that organizes \citet{Sargent2011}
operates on both of the lines introduced above.  On the money--credit side,
the primary analytical tension is between quantity-theory narrow banking and
the real bills doctrine.  Drawing sharp lines---via 100-percent reserve
requirements or bond-backed note issuance---stabilizes the price level but
creates inefficient rate-of-return wedges and incentives for evasion.
\citet{SargentWallace1982} showed that unfettered real-bills intermediation
can be Pareto superior in general equilibrium, but also that the real bills
criterion accommodates every credit expansion valued at current prices and
so tends to amplify rather than dampen fluctuations.  On the money--credit
line, neither polar arrangement dominates.

On the monetary--fiscal side, a useful accounting device is the government's
...
$\mu_t m_{t-1}$ enters as a revenue source alongside taxes and borrowing,
making the money supply and the price level potentially dependent on fiscal
outcomes.

Two polar institutional arrangements can be distinguished:
...
rule.  Price-level stability is guaranteed by the commitment, but the
fiscal authority cannot draw on money creation as a flexible revenue
instrument.

\textit{Fiscal dominance.}  The fiscal authority sets
$\{\tau_t,\, g_t,\, b_t\}$ autonomously and the monetary authority
passively supplies whatever seigniorage is required to clear
\eqref{eq:flow}.  The fiscal authority gains the flexibility to use money
creation as a revenue instrument alongside taxes and borrowing.  But
fiscal dominance makes the price level a fiscal consequence; a
deterioration in fiscal discipline is monetized.

As \citet{SargentWallace1981} showed with their ``unpleasant monetarist
arithmetic,'' neither arrangement dominates the other.  Monetary dominance
trades the option of seigniorage revenue for price-level stability;
fiscal dominance trades stability for fiscal flexibility.  Which side of
the line is preferable depends on the fiscal environment, the credibility
of institutional commitments, and the character of the shocks the
government faces.  The historical reversals documented below are
illustrations.
...
which its single attempt at implementation occurred.\footnote{\citet{Silber2012}
  provides a detailed account of the 1979--82 episode and its bearing
  on the contest between monetary and fiscal authority.  See p.~\pageref{} [page
  to be inserted].}
...
Webster's reversal is more pragmatic than Clay's---he moved from
objecting to a specific design to championing the institution, rather
than crossing a philosophical divide---but illustrates an additional force for changing minds.
  Where Clay was compelled by the evidence of fiscal
...
opposition to the First Bank was constitutional, grounded in a theory of federalism.
...
institutional practice over time.\footnote{Madison used the term
  ``liquidation'' for this process as early as \textit{Federalist}
  No.~37 (1788), where he wrote that the meaning of constitutional
  terms would be ``liquidated and ascertained by a series of
  particular discussions and adjudications.''  He returned to it in
  correspondence of the 1820s--30s to justify his acceptance of the
  Bank's constitutionality through long legislative practice.  For
  modern scholarly treatments see \citet{Nelson2003} and
  \citet{BaudeSachs2017}.  An economist will notice a double
  entendre: ``liquidation'' is also what banks do---converting
  illiquid assets into liquid (easily tradable) liabilities.  Madison's
  constitutional usage and the banker's usage share the same root
  metaphor: something fixed and opaque becomes fluid and
  transparent through use.}  By 1816, twenty-four years of the
...
\textbf{Rewrite -- if use any part, cite Lucas's review of McCracken report -- eclectic.}
